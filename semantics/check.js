...
module.exports = {
  ...
  isIntegerType(type) {
    doCheck(type.constructor === IntegerType, 'Not an integer type');
  },

  isStringType(type) {
    doCheck(type.constructor === StringType, 'Not a string type');
  },

  isBooleanType(type) {
    doCheck(type.constructor === BooleanType, 'Not a boolean type');
  },
